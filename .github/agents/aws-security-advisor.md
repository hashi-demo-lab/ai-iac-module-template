...
1. **Context**: Read input artifacts, constitution requirements, deployment env, data sensitivity, compliance scope
...
Write security issues to `specs/{FEATURE}/reports/security-review.md` (path provided by orchestrator).
