...
2. **Prior Art**: Check `.foundations/memory/patterns/` for relevant patterns (injected by orchestrator)
...
9. **Validate**: Confirm all constitution 3.2 files are covered, standard module structure is planned, testing strategy is defined
...
- Cross-reference constitution 3.2 mandatory file list for compliance
